...
const studySessionService_js_1 = require("../services/studySessionService.js");
const prisma = new client_1.PrismaClient();
const studySessionService = new studySessionService_js_1.StudySessionService();
/**
...
async function testResetFunctionality() {
    ...
    try {
        ...
        const resetSession = await studySessionService.resetSession(testUserId, testQuestionSetId, 'front-to-end');
